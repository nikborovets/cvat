...
def handler(context, event):
    try:
        ...
        context.logger.info(f"SAM2 Output Shapes: 0={high_res_feats_0.shape}, 1={high_res_feats_1.shape}, embed={image_embed.shape}")
        context.logger.info(f"SAM2 Output Dtypes: 0={high_res_feats_0.dtype}, 1={high_res_feats_1.dtype}, embed={image_embed.dtype}")
